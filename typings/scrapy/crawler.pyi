...
from typing import Any, Dict, Generator, TYPE_CHECKING, Type, Union
...
logger = ...
class Crawler:
    def __init__(self, spidercls: Type[Spider], settings: Union[None, Dict[str, Any], Settings] = ..., init_reactor: bool = ...) -> None:
        ...
...
class CrawlerProcess(CrawlerRunner):
    ...
    process. See :ref:`run-from-script` for an example.
    """
    def __init__(self, settings: Union[Dict[str, Any], Settings, None] = ..., install_root_handler: bool = ...) -> None:
        ...
